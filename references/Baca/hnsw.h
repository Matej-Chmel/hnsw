...
*/
	...
	private:
		...
		inline float* getNodeVector(pointer_t node_order) {
			return vector_data_ + node_order * vector_size_;
		}
		...
		inline uint8_t* aprGetNodeVector(pointer_t node_order) {
			return apr_vector_data + node_order * vector_size_;
		}
